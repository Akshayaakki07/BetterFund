...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    console.error("Env Var SEPOLIA_RPC_URL:", process.env.SEPOLIA_RPC_URL ? "Defined" : "Undefined");
...
function CampaignCard({
  ...
  console.log("Rendering Campaign:", name, "ImageURL:", imageURL);
  return (
      ...
      <main className={styles.main}>
        ...
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} id="howitworks">
          ...
          <Heading as="h2" size="lg" mt="8">
            ...
            <Link
              color="teal.500"
              href="https://github.com/Akshayaakki07/BetterFund.git"
              isExternal
            >
